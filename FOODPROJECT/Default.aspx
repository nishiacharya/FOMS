...
<head runat="server">
    ...
    <link rel="icon" href="images/favicon.ico" type="images/up.jpg"/>
...
<body>
    ...
    <header>
        ...
        <div class="toggle-menu-container" style="color:black;font-weight:bold;">
            <nav class="nav">
                <div class="nav_title"></div>
                <a class="sf-menu-toggle fa fa-bars" href="#" style="right: 51px; top: 51px;background-color:wheat;color:black;font-weight:bold;"></a>
                <ul class="sf-menu">
                   <li class="active">
    ...
    <main style="background-color:lightyellow;">
        ...
        <section style="background-color:lightyellow;">
        <div class="container">
                <h2 style="font-family:cursive;font-size:300%;font-weight:bold;height:80px;text-align:center;">Our Menu</h2>
            </div>  
            <div class="gallery">
                <div class="gallery_col-1">
                    ...
                    <a data-fancybox-group="gallery" href="Product.aspx?id=3" class="gallery_item thumb lazy-img" style="padding-bottom: 98.7551724137931%;">
                ...
                <div class="gallery_col-2">
                    ...
                    <a data-fancybox-group="gallery" href="Product.aspx?id=6" class="gallery_item thumb lazy-img" style="padding-bottom: 97.80738255033557%;">
               ...
               <a data-fancybox-group="gallery" href="Product.aspx?id=9" class="gallery_item thumb lazy-img" style="padding-bottom: 93.69676320272572%;">
                    ...
                    <a data-fancybox-group="gallery" href="Product.aspx?id=7" class="gallery_item thumb lazy-img" style="padding-bottom: 93.89676320272572%;">
        ...
        <section style="background-color:lightyellow;height:100%;"><br />
            <div class="container">
                <h2 style="font-family:cursive;font-size:300%;font-weight:bold;">Contact US</h2><br /><br>
